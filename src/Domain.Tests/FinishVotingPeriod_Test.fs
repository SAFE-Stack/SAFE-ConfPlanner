...
let ``Cannot finish a voting period when not all abstracts have votes from every organizer`` () =
  ...
  let votings =
    [
      vote talk3 voter1 (Points 1)
      vote talk3 voter2 (Points 1)
      vote talk3 voter3 (Points 1)
      vote talk2 voter1 (Points 1)
      vote talk2 voter2 (Points 1)
      vote talk2 voter3 (Points 1)
      vote talk1 voter1 (Points 1)
      vote talk1 voter2 (Points 1)
    ]
  let conference =
    conference
    |> withCallForPapersClosed
...
let ``Voting top x abstracts will be accepted, others will be rejected`` () =
  ...
  let votings =
    [
      vote talk3 voter1 (Points -2)
      vote talk3 voter2 (Points -2)
      vote talk3 voter3 (Points -2)
      vote talk2 voter1 (Points 2)
      vote talk2 voter2 (Points 2)
      vote talk2 voter3 (Points 2)
      vote talk1 voter1 (Points -1)
      vote talk1 voter2 (Points 1)
      vote talk1 voter3 (Points -1)
    ]
